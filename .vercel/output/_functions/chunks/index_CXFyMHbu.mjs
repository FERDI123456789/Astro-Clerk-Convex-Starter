...
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CLERK_PUBLISHABLE_KEY": "pk_test_dGVhY2hpbmctbGFiLTU3LmNsZXJrLmFjY291bnRzLmRldiQ", "PUBLIC_CONVEX_URL": "https://nautical-gnu-769.convex.cloud", "SITE": void 0, "SSR": true };
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_H3M3F0GAxkRhWejhfvDo2IEQr13xarZt4BYItjvwnv", BROWSER: process.env.BROWSER, _: process.env._ })[envVarName];
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  sdkMetadata: {
    ...
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_H3M3F0GAxkRhWejhfvDo2IEQr13xarZt4BYItjvwnv", BROWSER: process.env.BROWSER, _: process.env._ }).MODE
  },
  telemetry: {
